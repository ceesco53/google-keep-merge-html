...
data_folder = '/Users/jonelson/Downloads/broadcom onboarding/keep export/Keep'
style = """
body {
...
output_doc.head.append(output_doc.new_tag('style', type='text/css'))
output_doc.head.style.append(style)
...
for file in os.listdir(data_folder):
    ...
    with open(data_folder + '/' + file, 'r') as html_file:
